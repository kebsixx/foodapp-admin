  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Test connectivity to the Cloudinary API
        </CardDescription>
      </CardHeader>
              ...
              {networkStatus.status === "success" && (
                <div className="mt-2 text-sm">
                  ...
                  {networkStatus.downloadSpeed && (
                    <p>
                      Download speed: {networkStatus.downloadSpeed.toFixed(2)}{" "}
                      KB/s
                    </p>
                  )}
                  {networkStatus.uploadSpeed && (
                    <p>
                      Upload speed: {networkStatus.uploadSpeed.toFixed(2)} KB/s
                    </p>
                  )}

                  {networkStatus.uploadSpeed &&
                    networkStatus.uploadSpeed < 50 && (
                      <p className="mt-2 text-amber-600 font-medium">
                        ⚠️ Your upload speed is very low, which may cause
                        timeouts when uploading images.
                      </p>
                    )}
                </div>
              )}
