...
>(({ className, children, "aria-describedby": ariaDescribedby = "dialog-description", ...props }, ref) => {
  ...
  const describedById = ariaDescribedby || `dialog-description-${dialogId}`;
  
  // Check if there's already a DialogDescription in the children
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {!hasDescription && (
          <DialogDescription id={describedById} className="sr-only">
            Dialog content
          </DialogDescription>
        )}
